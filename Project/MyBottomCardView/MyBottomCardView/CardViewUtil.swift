...
class CardViewUtil {
    ...
    public static func showCardViewController(context: UIViewController, contentView: UIView, isHandleVisible: Bool = false, cornerRadius: CGFloat = 0.0, isCancelButtonVisible: Bool = false, cancelText: String = "취소", cancelCompletion: (() -> ())? = nil, isSubmitButtonVisible: Bool = false, submitText: String = "확인",  submitCompletion: (() -> ())? = nil) {
